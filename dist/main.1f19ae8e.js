...
var $lastList = $(".main").find(".last");

simplify = function simplify(x) {
  return x.replace("http://", "").replace("https://", "").replace("www.", "").replace(/\/.*/, "");
};

var yy = localStorage.getItem("xx");
var yyObject = JSON.parse(yy);
var hashMap = yyObject || [{
...
var render = function render() {
  ...
  hashMap.forEach(function (node, index) {
    var url = node.url;
    var link = simplify(url);
    var connection = link.replace(".", "");
    var $li = $("<li class=\"content\">\n      <div class=\"container\">\n      <div class=\"close\"><svg class=\"icon-x\" >\n      <use xlink:href=\"#icon-close\"></use>\n      </svg></div>\n        <div class=\"png-A\">\n          <div class=\"image\">\n           <img id=\"".concat(connection, "\" src=\"https://").concat(link, "/favicon.ico\" />\n          </div>\n        </div>\n        <span>").concat(link, "</span>\n      </div>\n  </li>")).insertBefore($lastList);
...
$(".icon-a").on("click", function () {
  var hh = window.prompt("请输入要收藏的网站网址");
